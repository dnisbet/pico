...
class DS1302:
    ...
    def __init__(self, clk_pin=14, data_pin=12, ce_pin=13):
        # CLK and CE (sometime call RST) pin are always output
        self._clk_pin = Pin(clk_pin, Pin.OUT,value=0)
        self._data_pin_no = data_pin
        self._ce_pin = Pin(ce_pin, Pin.OUT,value=0)
